...
#%%
    ...
    azure_chest_xray_sym_test = torch.load("Model_all_20_4-23-18.model")
    optimizer, criterion, scheduler = init_symbol(azure_chest_xray_sym_test)
    ...
    #     loss_val, loss_val2 = valid_epoch(azure_chest_xray_sym, valid_loader, criterion, j)
    ...
    #         loss_min = loss_val
    #         torch.save(azure_chest_xray_sym, 'Model_all_20_4-23-18.model')
